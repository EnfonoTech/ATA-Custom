...
PROJECTS = [{'code': '2601',
 ...
 {'code': '2602', 'name': 'AL NAJEM', 'concept': False, 'folder': '2602 - AL NAJEM'},
 {'code': '2603',
  'name': 'JAREED HOTEL - JEDDAH',
  'concept': False,
  'folder': '2603 - JAREED HOTEL - JEDDAH'},
 {'code': '2604', 'name': 'ALHOWIRINY', 'concept': False, 'folder': '2604 - ALHOWIRINY'},
 {'code': '2605', 'name': 'NAIF ALMUSA - 2', 'concept': False, 'folder': '2605 - NAIF ALMUSA - 2'},
 {'code': '2606', 'name': 'NMR KAFD', 'concept': False, 'folder': '2606 - NMR KAFD'},
 {'code': '2607', 'name': 'NMR LABAN', 'concept': False, 'folder': '2607 - NMR LABAN'},
 {'code': '2608',
 ...
 {'code': '2610', 'name': 'LETHAM 02', 'concept': False, 'folder': '2610 - LETHAM 02'},
 {'code': '2611',
...
GROUPS = [{'department': 'ATA RIYADH HQ',
  'office': 'RIYADH',
  'members': ['mohsin@ata.com.sa',
              'it.hq@ata.com.sa',
              'sabu@ata.com.sa',
              'moe@ata.com.sa',
 ...
 {'department': 'MANILA OFFICE 02',
  'office': 'MANILA',
  'members': ['jonathan@ata.com.sa', 'jio@ata.com.sa']},
 {'department': 'ATA RIYADH SUPERVISION TEAM',
  'office': 'RIYADH',
  'members': ['m.d@ata.com.sa',
              'momen@ata.com.sa',
              'a.elhadi@ata.com.sa',
...
USERS = [{'email': 'a.elhadi@ata.com.sa', 'full_name': 'Abdel Moneim Elhadi', 'client_roles': ['MEMBER']},
 {'email': 'abdelwahab@ata.com.sa', 'full_name': 'Ahmed Abdelwahab', 'client_roles': ['MEMBER']},
 {'email': 'accounts@ata.com.sa',
  'full_name': 'MUZAMIL HUSSAIN MOHAMMED',
  'client_roles': ['ACCOUNTANT']},
 {'email': 'ahmed.embaby@ata.com.sa',
  'full_name': 'Ahmed Alaa Embaby',
  'client_roles': ['COORDINATION TEAM MEMBER']},
 {'email': 'alaa.ahmed@ata.com.sa', 'full_name': 'Alaa Ibrahim ahmed', 'client_roles': ['MEMBER']},
 {'email': 'aleksandr.velgan@ata.com.sa',
  'full_name': 'Aleksandr Velgan',
  'client_roles': ['MEMBER']},
 {'email': 'alzard@ata.com.sa',
  'full_name': 'Ahmad Alzard',
  'client_roles': ['BALADIA DEPT MANAGER']},
 {'email': 'amr.gaber@ata.com.sa', 'full_name': 'Amr Gaber', 'client_roles': ['MEMBER']},
 {'email': 'ana@ata.com.sa', 'full_name': 'Ana Tendeiro', 'client_roles': ['MANAGER']},
 {'email': 'antonio@ata.com.sa', 'full_name': 'António Pedro', 'client_roles': ['MEMBER']},
 {'email': 'arnel@ata.com.sa', 'full_name': 'Arnel M. Pawa-an', 'client_roles': ['MEMBER']},
 ...
 {'email': 'beatriz.velosa@ata.com.sa',
  ...
  'client_roles': ['MEMBER']},
 {'email': 'bruno@ata.com.sa', 'full_name': 'Bruno Madaleno', 'client_roles': ['MEMBER']},
 {'email': 'dalva@ata.com.sa', 'full_name': 'Dalva Fernandes', 'client_roles': ['MEMBER']},
 {'email': 'daromero@ata.com.sa', 'full_name': 'Dexter Romero', 'client_roles': ['MEMBER']},
 {'email': 'diogo.brito@ata.com.sa', 'full_name': 'Diogo Brito', 'client_roles': ['MEMBER']},
 {'email': 'don@ata.com.sa', 'full_name': 'DON ARDIE', 'client_roles': ['MEMBER']},
 {'email': 'filipa.leite@ata.com.sa', 'full_name': 'Filipa Leite', 'client_roles': ['MEMBER']},
 {'email': 'filipa.lindo@ata.com.sa', 'full_name': 'Filipa Lindo', 'client_roles': ['MEMBER']},
 {'email': 'florbela@ata.com.sa', 'full_name': 'Florbela Antunes', 'client_roles': ['MEMBER']},
 {'email': 'gaius@ata.com.sa', 'full_name': 'Gaius Kabigting', 'client_roles': ['MANAGER']},
 {'email': 'hamada.ramada@ata.com.sa', 'full_name': 'Hamada Ramadan', 'client_roles': ['MEMBER']},
 {'email': 'hatem.salem@ata.com.sa', 'full_name': 'Hatem Salem', 'client_roles': ['MEMBER']},
 {'email': 'hr.riyadh@ata.com.sa', 'full_name': 'ATA RIYADH HR', 'client_roles': ['HR']},
 {'email': 'it.hq@ata.com.sa', 'full_name': 'IT HQ', 'client_roles': ['OWNER']},
 {'email': 'jawdat.shaddad@ata.com.sa', 'full_name': 'Jawdat Shaddad', 'client_roles': ['MEMBER']},
 {'email': 'jio@ata.com.sa', 'full_name': 'Jio Marco Araullo', 'client_roles': ['MEMBER']},
 {'email': 'jjose@ata.com.sa', 'full_name': 'Jovaany Jose', 'client_roles': ['MEMBER']},
 {'email': 'joao.novais@ata.com.sa', 'full_name': 'João Novais', 'client_roles': ['MEMBER']},
 {'email': 'jonathan@ata.com.sa', 'full_name': 'Jonathan Sadsad', 'client_roles': ['MANAGER']},
 {'email': 'katia@ata.com.sa', 'full_name': 'Kátia Tendeiro', 'client_roles': ['HR']},
 ...
 {'email': 'khalid.ali@ata.com.sa',
  ...
  'client_roles': ['MEMBER']},
 {'email': 'leonor@ata.com.sa', 'full_name': 'Leonor Contreiras', 'client_roles': ['MEMBER']},
 {'email': 'luis.peralta@ata.com.sa', 'full_name': 'Luis Peralta', 'client_roles': ['MEMBER']},
 {'email': 'm.d@ata.com.sa',
  'full_name': 'Mahmoud Daif',
  'client_roles': ['MANAGER', 'SUPERVISION  TEAM MANAGER']},
 {'email': 'm.haggag@ata.com.sa',
  'full_name': 'Mohamed Haggag',
  'client_roles': ['COORDINATION TEAM MANAGER']},
 {'email': 'marta@ata.com.sa', 'full_name': 'Marta Pereira', 'client_roles': ['MEMBER']},
 {'email': 'martina@ata.com.sa', 'full_name': 'Martina Darbutaitė', 'client_roles': ['MEMBER']},
 {'email': 'moe@ata.com.sa', 'full_name': 'Mohamed Qasem', 'client_roles': ['HR']},
 {'email': 'mohammed.amal@ata.com.sa', 'full_name': 'Mohammed Amal', 'client_roles': ['MEMBER']},
 {'email': 'mohsin@ata.com.sa', 'full_name': 'Abdulmohsin Thiab', 'client_roles': ['OWNER']},
 {'email': 'momen@ata.com.sa',
  'full_name': 'Momen Abdel Razzaq',
  'client_roles': ['MEMBER', 'STRUCTURAL DEPT. MANAGER']},
 {'email': 'naveed.ahmed@ata.com.sa', 'full_name': 'Naveed Ahmed', 'client_roles': ['MEMBER']},
 {'email': 'nuno@ata.com.sa', 'full_name': 'Nuno Calado', 'client_roles': ['MEMBER']},
 {'email': 'osama@ata.com.sa', 'full_name': 'Osama Kiwan', 'client_roles': ['MEMBER']},
 {'email': 'osamaa.elmahdawy@ata.com.sa',
  'full_name': 'Osama Ahmed El Mahdawy',
  'client_roles': ['MEMBER']},
 {'email': 'pedro.c@ata.com.sa', 'full_name': 'Pedro Cardia', 'client_roles': ['MEMBER']},
 {'email': 'pimenta@ata.com.sa', 'full_name': 'Pedro Miguel Pimenta', 'client_roles': ['MEMBER']},
 {'email': 'rey@ata.com.sa', 'full_name': 'Reynaldo Pabilona', 'client_roles': ['TEAM MANAGER']},
 {'email': 'rg@ata.com.sa', 'full_name': 'Roderick Garcia', 'client_roles': ['MEMBER']},
 {'email': 'rita@ata.com.sa', 'full_name': 'Rita Campino', 'client_roles': ['MANAGER']},
 {'email': 'rodrigo@ata.com.sa', 'full_name': 'Rodrigo Silvestre', 'client_roles': ['MEMBER']},
 {'email': 'ruben.aires@ata.com.sa', 'full_name': 'Rúben Aires', 'client_roles': ['MEMBER']},
 {'email': 'sabu@ata.com.sa', 'full_name': 'Sabu Klbm', 'client_roles': ['OWNER']},
 {'email': 'samer@ata.com.sa',
  'full_name': 'Samer Mohamed Abdullah Hassan',
  'client_roles': ['MATERIAL TEAM MANAGER']},
 {'email': 'sandro.leite@ata.com.sa', 'full_name': 'Sandro Leite', 'client_roles': ['MEMBER']},
 {'email': 'sara.alexandra@ata.com.sa',
  'full_name': 'Sara Alexandra Albuquerque',
  'client_roles': ['MEMBER']},
 {'email': 'sergio.c@ata.com.sa', 'full_name': 'Sergio Calais', 'client_roles': ['MEMBER']},
 {'email': 'shainna@ata.com.sa', 'full_name': 'Shainna Pilapil', 'client_roles': ['MEMBER']},
 {'email': 't.calais@ata.com.sa', 'full_name': 'Tiago Calais', 'client_roles': ['MEMBER']},
 {'email': 'tiago@ata.com.sa', 'full_name': 'Tiago Guerreiro', 'client_roles': ['MANAGER']},
 {'email': 'vasco@ata.com.sa', 'full_name': 'Vasco Antunes', 'client_roles': ['MEMBER']},
 {'email': 'vera@ata.com.sa', 'full_name': 'Vera Nunes', 'client_roles': ['MEMBER']},
